...
public final class MangerAcc_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t<h2>\n");
      out.write("\t\t\t\t\t\t\t\tManage <b>Account</b>\n");
      out.write("\t\t\t\t\t\t\t</h2>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div class=\"col-sm-6\">\n");
      out.write("\t\t\t\t\t\t\t<a href=\"#addAccountModal\" class=\"btn btn-success\"\n");
      out.write("\t\t\t\t\t\t\t\tdata-toggle=\"modal\"> <span>Add New Account</span></a> <a\n");
      out.write("\t\t\t\t\t\t\t\thref=\"home\" class=\"btn btn-danger\"><span>return</span></a>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<label>Account Name</label> <input name=\"aname\" type=\"text\"\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-control\" required>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label>Password</label> <input name=\"pass\" type=\"password\"\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-control\" required>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label>Is Sell</label> <input name=\"issell\" type=\"text\"\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-control\" required>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label>Is Admin</label> <input name=\"isadmin\" type=\"text\"\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-control\" required>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("</td>\n");
          out.write("\t\t\t\t\t\t\t\t<td><a href=\"loadAcc?aid=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${o.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" class=\"editAcc\"\n");
          out.write("\t\t\t\t\t\t\t\t\tdata-toggle=\"modal\"><i class=\"material-icons\"\n");
          out.write("\t\t\t\t\t\t\t\t\t\tdata-toggle=\"tooltip\" title=\"Edit\">&#xE254;</i></a> <a\n");
          out.write("\t\t\t\t\t\t\t\t\thref=\"deleteAcc?aid=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${o.id}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("\" class=\"delete\" data-toggle=\"modal\"><i\n");
